 ...
 * @msg: The messege to append
 * @error: The error string to build
 * @ver_str: The varion string
 * Return: A poiner to the concatenated error string
 */
 ...
 * @datash: A pointer to the data shell struct
 * Return: A pointer to the generated errr message
 */
 ...
 * @datash: A pointer to the data shell struct
 * Return: The error messege string
 */
...
/**
 * error_exit_shell - A function that generate the error messege
 * @datash: A pointer to the data shell struct
 *
 * Return: The error messege string
 */
