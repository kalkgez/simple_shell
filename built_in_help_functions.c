...
/**
 * aux_help_setenv - A function that displays
 * help information  for the setenv command
 * Return: void
 */
...
/**
 * aux_help_unsetenv -  A function that displays
 * help information  for the unsetenv command
 * Return: void
 */
